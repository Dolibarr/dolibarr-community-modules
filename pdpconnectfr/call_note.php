...
$langs->loadLangs(array("pdpconnectfr@pdpconnectfr", "companies"));
...
if ($id > 0 || !empty($ref)) {
	$upload_dir = $conf->pdpconnectfr->multidir_output[empty($object->entity) ? $conf->entity : $object->entity]."/".$object->id;
}
...
$title = $langs->trans('Call').' - '.$langs->trans("Notes");
//$title = $object->ref." - ".$langs->trans("Notes");
$help_url = '';
//$help_url='EN:Customers_Orders|FR:Commandes_Clients|ES:Pedidos de clientes';

llxHeader('', $title, $help_url, '', 0, 0, '', '', '', 'mod-pdpconnectfr page-card_notes');
