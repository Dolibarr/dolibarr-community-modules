...
/**
 * \file    pdpconnectfr/css/pdpconnectfr.css.php
 * \ingroup pdpconnectfr
 * \brief   CSS file for module PDPConnectFR.
 */
...
.syncParametersSection {
	border: 1px solid #ccc;
	padding: 10px;
	background-color: #f9f9f9;
}

.syncParametersSection #runSyncBtn {
	margin-left: 0px;
}

.syncParametersSection .syncFormLabel {
	padding-right: 10px;
}