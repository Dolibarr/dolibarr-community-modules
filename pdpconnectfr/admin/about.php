...
/**
 * \file    pdpconnectfr/admin/about.php
 * \ingroup pdpconnectfr
 * \brief   About page of module PDPConnectFR.
 */
...
// Translations
$langs->loadLangs(array("errors", "admin", "pdpconnectfr@pdpconnectfr"));
...
dol_include_once('/pdpconnectfr/core/modules/modPDPConnectFR.class.php');
$tmpmodule = new modPDPConnectFR($db);
