...
class ReaderBasicTest extends TestCase
{
	...
	public function testDocumentSummation(): void
	{
		...
		$this->assertEqualsWithDelta(235.62, $grandTotalAmount, PHP_FLOAT_EPSILON);
		$this->assertEqualsWithDelta(235.62, $duePayableAmount, PHP_FLOAT_EPSILON);
		...
		$this->assertEqualsWithDelta(198.0, $taxBasisTotalAmount, PHP_FLOAT_EPSILON);
		$this->assertEqualsWithDelta(37.62, $taxTotalAmount, PHP_FLOAT_EPSILON);
