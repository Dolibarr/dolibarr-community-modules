...
class FacturXProtocol extends AbstractProtocol
{
	...
	// 	$note_pub = dol_concatdesc($note_pub, ' - Einvoice FacturX generated by Dolibarr ' . DOL_VERSION);	// Useful for tracing and debugging, will see later to disable this.
	...
	// 			$facturxpdf->setDocumentInvoiceReferencedDocument($depositFactRef, ZugferdInvoiceType::PREPAYMENTINVOICE, $depositFactDate); // Add reference to original invoice but in document level
	...
	// 			->setDocumentPositionQuantity($line->qty, "C62") // H87 = Pieces, C62 = unit (TODO: customize unit code, required from 09/2027) https://unece.org/trade/documents/2021/06/uncefact-rec20-0
	...
	// 			$this->_getPaymentMeanNumber($object),
