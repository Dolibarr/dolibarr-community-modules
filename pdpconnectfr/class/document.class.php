...
class Document extends CommonObject
{
	...
	public $fields = array(
		...
		"document_body" => array("type" => "text", "label" => "document_body", "enabled" => "1", 'position' => 110, 'notnull' => 0, "visible" => "1", "comment" => "Full document content XML"),
		...
		"flow_uiid" => array("type" => "varchar(255)", "label" => "flow_uiid", "enabled" => "1", 'position' => 180, 'notnull' => 0, "visible" => "1",),
		"cdar_lifecycle_code" => array("type" => "varchar(50)", "label" => "cdar_lifecycle_code", "enabled" => "1", 'position' => 190, 'notnull' => 0, "visible" => "1",),
		"cdar_lifecycle_label" => array("type" => "varchar(255)", "label" => "cdar_lifecycle_label", "enabled" => "1", 'position' => 200, 'notnull' => 0, "visible" => "1",),
		"cdar_reason_code" => array("type" => "varchar(50)", "label" => "cdar_reason_code", "enabled" => "1", 'position' => 210, 'notnull' => 0, "visible" => "1",),
		"cdar_reason_desc" => array("type" => "varchar(255)", "label" => "cdar_reason_desc", "enabled" => "1", 'position' => 220, 'notnull' => 0, "visible" => "1",),
		"cdar_reason_detail" => array("type" => "text", "label" => "cdar_reason_detail", "enabled" => "1", 'position' => 230, 'notnull' => 0, "visible" => "1",),
	);
	public $rowid;
