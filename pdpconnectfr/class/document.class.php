...
class Document extends CommonObject
{
	...
	public $fields = array(
		...
		"flow_profile" => array("type" => "varchar(50)", "label" => "flow_profile", "enabled" => "1", 'position' => 0, 'notnull' => 0, "visible" => "1", "comment" => "Profile used (Basic, Cius, etc.)"),
		"ack_status" => array("type" => "varchar(50)", "label" => "ack_status", "enabled" => "1", 'position' => 0, 'notnull' => 0, "visible" => "1", "comment" => "Acknowledgment status (Success, Error, Pending)"),
		"ack_reason_code" => array("type" => "varchar(255)", "label" => "ack_reason_code", "enabled" => "1", 'position' => 0, 'notnull' => 0, "visible" => "1", "comment" => "Reason code if error"),
		"ack_info" => array("type" => "text", "label" => "ack_info", "enabled" => "1", 'position' => 0, 'notnull' => 0, "visible" => "1", "comment" => "Additional information if error/warning"),
