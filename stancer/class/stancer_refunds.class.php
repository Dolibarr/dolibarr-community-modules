...
/**
 * \file        class/stancer_refunds.class.php
 * \ingroup     stancer
 * \brief       This file is a CRUD class file for Stancer_refunds (Create/Read/Update/Delete)
 */
...
/**
 * Class for Stancer_refunds
 */
class Stancer_refunds extends CommonObject
{
	public const TRIGGER_PREFIX = 'STANCER_REFUND';
	 ...
	 */
	public $element = 'stancer_refunds';

	/**
	 * @var string Name of table without prefix where object is stored. This is also the key used for extrafields management.
	 */
	public $table_element = 'stancer_stancer_refunds';
	...
	/**
	 * @var string String with name of icon for stancer_refunds. Must be a 'fa-xxx' fontawesome code (or 'fa-xxx_fa_color_size') or 'stancer_refunds@stancer' if picto is file 'img/object_stancer_refunds.png'.
	 */
	...
	public $fields=array(
		...
		'refund_id' => array('type'=>'varchar(30)', 'label'=>'StancerRefundID', 'enabled'=>'1', 'position'=>20, 'notnull'=>1, 'visible'=>1, 'index'=>1, 'showoncombobox'=>'1', 'validate'=>'1', 'comment'=>"Reference of object", 'default'=>null),
		'payment_id' => array('type'=>'varchar(30)', 'label'=>'StancerPaymentID', 'enabled'=>'1', 'position'=>25, 'notnull'=>1, 'visible'=>1, 'index'=>1, 'showoncombobox'=>'1', 'validate'=>'1', 'comment'=>"Reference of object", 'default'=>null),
		...
		'currency' => array('type'=>'varchar(4)', 'label'=>'Currency', 'enabled'=>'1', 'position'=>50, 'notnull'=>0, 'visible'=>-1, 'showoncombobox'=>'1', 'validate'=>'1', 'comment'=>"Currency", 'default'=>null),
		'status' => array('type'=>'integer', 'label'=>'Status', 'enabled'=>'1', 'position'=>70, 'notnull'=>1, 'visible'=>1, 'index'=>1, 'arrayofkeyval'=>array('0'=>'draft', '1'=>'authorized', '2'=>'captured', '3'=>'capture_sent', '4'=>'disputed', '5'=>'expired', '6'=>'failed', '7'=>'refused', '8'=>'to_capture'), 'validate'=>'1', 'default'=>0),
		'created' => array('type'=>'datetime', 'label'=>'created', 'enabled'=>'1', 'position'=>80, 'notnull'=>0, 'visible'=>-1, 'showoncombobox'=>'1', 'validate'=>'1', 'comment'=>"The Unix timestamp representing creation date of the object in local time", 'default'=>null),
		'date_refund' => array('type'=>'timestamp', 'label'=>'date_refund', 'enabled'=>'1', 'position'=>90, 'notnull'=>0, 'visible'=>-1, 'showoncombobox'=>'1', 'validate'=>'1', 'comment'=>"Timestamp of the delivery date of the funds traded by the bank", 'default'=>null),
		'date_bank' => array('type'=>'timestamp', 'label'=>'date_bank', 'enabled'=>'1', 'position'=>100, 'notnull'=>0, 'visible'=>-1, 'showoncombobox'=>'1', 'validate'=>'1', 'comment'=>"Timestamp of the delivery date of the funds traded by the bank", 'default'=>null),
		'live_mode' => array('type'=>'boolean', 'label'=>'live_mode', 'enabled'=>'1', 'position'=>190, 'notnull'=>0, 'visible'=>3, 'showoncombobox'=>'1', 'validate'=>'1', 'comment'=>"Test or Live mode", 'default'=>0),
	...
	//  */
	// public $table_element_line = 'stancer_stancer_refundsline';

	// /**
	//  * @var string    Field with ID of parent key if this object has a parent
	//  */
	// public $fk_element = 'fk_stancer_refunds';

	// /**
	//  * @var string    Name of subtable class that manage subtable lines
	//  */
	// public $class_element_line = 'Stancer_refundsline';

	// /**
	//  * @var array	List of child tables. To test if we can delete object.
	//  */
	// protected $childtables = array('mychildtable' => array('name'=>'Stancer_refunds', 'fk_element'=>'fk_stancer_refunds'));
	...
	//  */
	// protected $childtablesoncascade = array('stancer_stancer_refundsdet');

	// /**
	//  * @var Stancer_refundsLine[]     Array of subtable lines
	//  */
	// public $lines = array();
	...
	public function __construct(DoliDB $db)
	{
		...
		/*if ($user->hasRight('stancer', 'stancer_refunds', 'read')) {
	...
	public function fetch($id, $ref = null, $refund_id = null)
	{
		$more = "";
		if (!empty($refund_id)) {
			$more = " AND refund_id='" . $this->db->escape($refund_id) . "'";
		}
	...
	public function validate($user, $notrigger = 0)
	{
		...
		// Update status only (no ref column in Stancer tables, we use refund_id as reference)
		...
		if (!$error && !$notrigger) {
			// Call trigger
			$result = $this->call_trigger('STANCER_REFUNDS_VALIDATE', $user);
			if ($result < 0) {
				$error++;
			}
		}
	...
	public function setDraft($user, $notrigger = 0)
	{
		...
		/* if (! ((!getDolGlobalInt('MAIN_USE_ADVANCED_PERMS') && $user->hasRight('stancer','write'))
		 || (getDolGlobalInt('MAIN_USE_ADVANCED_PERMS') && $user->hasRight('stancer','stancer_advance','validate'))))
		 {
	...
	public function getTooltipContentArray($params)
	{
		...
		if (getDolGlobalInt('MAIN_OPTIMIZEFORTEXTBROWSER')) {
			return ['optimize' => $langs->trans("ShowStancer_refunds")];
		}
		$datas['picto'] = img_picto('', $this->picto).' <u>'.$langs->trans("Stancer_refunds").'</u>';
	...
	public function getNomUrl($withpicto = 0, $option = '', $notooltip = 0, $morecss = '', $save_lastsearch_value = -1)
	{
		...
		if (empty($notooltip)) {
			if (getDolGlobalInt('MAIN_OPTIMIZEFORTEXTBROWSER')) {
				$label = $langs->trans("ShowStancer_refunds");
	...
	public function fillDataFromApi($apiData)
	{
		...
		$apiStatus = isset($apiData['status']) ? $apiData['status'] : '';
		$mappedStatus = isset($statusMap[$apiStatus]) ? $statusMap[$apiStatus] : 0;

		$this->refund_id = isset($apiData['id']) ? $apiData['id'] : '';
		...
		$this->date_refund = isset($apiData['date_refund']) ? $apiData['date_refund'] : null;
	...
	public function getLinesArray()
	{
		...
		$objectline = new Stancer_refundsLine($this->db);
		$result = $objectline->fetchAll('ASC', 'position', 0, 0, array('customsql'=>'fk_stancer_refunds = '.((int) $this->id)));
	...
	public function generateDocument($modele, $outputlangs, $hidedetails = 0, $hidedesc = 0, $hideref = 0, $moreparams = null)
	{
		...
		if (!dol_strlen($modele)) {
			$modele = 'standard_stancer_refunds';
	...
	public function showOutputField($val, $key, $object, $moreparam = '', $keysuffix = '', $keyprefix = '', $showsize = 0)
	{
		...
		if ($key == 'refund_id') {
			...
			if (getDolGlobalString('STANCER_SHOW_RAW_API_PICTO', '0') == '1') {
				$link = " <a href='#' class='stancer-raw-link' data-stancer-type='refund' data-stancer-id='" . dol_escape_htmltag($object) . "' title='" . dol_escape_htmltag($langs->trans('ShowRawApiResponse')) . "'>" . img_picto($langs->trans('ShowRawApiResponse'), 'search') . "</a>";
				return $label . $link;
			}
			return $label;
		}
...
/**
 * Class Stancer_refundsLine. You can also remove this and generate a CRUD class for lines objects.
 */
class Stancer_refundsLine extends CommonObjectLine
{
	// To complete with content of an object Stancer_refundsLine
	// We should have a field rowid, fk_stancer_refunds and position
	public $db;
