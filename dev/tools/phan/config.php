...
/**
 * Generate submodules directory list to scan
 *
 * @return string[]  List of subproject directories
 */
function directory_list()
{
	...
	array_unshift($directories, 'dev/tools/phan/stubs');
	return $directories;
}
...
return [
	...
	'minimum-target-php-version' => '7.2',
	...
	'exclude_file_regex' => '@^('
		...
		.'|[^/]*/test/.*'
		.'|.*/vendor/.*'
		.'|einvoicing/class/protocols/ExampleHelpers\.php'
		.')$@',
