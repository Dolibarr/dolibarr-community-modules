...
/**
 *  \file       document_contact.php
 *  \ingroup    einvoicing
 *  \brief      Tab for contacts linked to Document
 */
...
$title = $langs->trans("Document")." - ".$langs->trans('ContactsAddresses');
//$title = $object->ref." - ".$langs->trans('ContactsAddresses');
$help_url = '';
//$help_url='EN:Module_Third_Parties|FR:Module_Tiers|ES:Empresas';
llxHeader('', $title, $help_url, '', 0, 0, '', '', '', 'mod-einvoicing page-card_contact');
...
if ($object->id) {
	...
	print dol_get_fiche_head($head, 'contact', $langs->trans("Document"), -1, $object->picto);
