...
/**
 *  \file       document_note.php
 *  \ingroup    einvoicing
 *  \brief      Tab for notes on Document
 */
...
$langs->loadLangs(array("einvoicing@einvoicing", "companies"));
...
if ($id > 0 || !empty($ref)) {
	$upload_dir = $conf->einvoicing->multidir_output[empty($object->entity) ? $conf->entity : $object->entity]."/".$object->id;
}
...
$title = $langs->trans('Document').' - '.$langs->trans("Notes");
//$title = $object->ref." - ".$langs->trans("Notes");
$help_url = '';
//$help_url='EN:Customers_Orders|FR:Commandes_Clients|ES:Pedidos de clientes';

llxHeader('', $title, $help_url, '', 0, 0, '', '', '', 'mod-einvoicing page-card_notes');
...
if ($id > 0 || !empty($ref)) {
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("Document"), -1, $object->picto);
