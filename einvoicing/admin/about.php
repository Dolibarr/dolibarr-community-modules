...
/**
 * \file    einvoicing/admin/about.php
 * \ingroup einvoicing
 * \brief   About page of module EInvoicing.
 */
...
llxHeader('', $langs->trans($title), $help_url, '', 0, 0, '', '', '', 'mod-einvoicing page-admin_about');
...
print dol_get_fiche_head($head, 'about', $langs->trans($title), 0, 'einvoicing@einvoicing');

dol_include_once('/einvoicing/core/modules/modEInvoicing.class.php');
$tmpmodule = new modEInvoicing($db);
