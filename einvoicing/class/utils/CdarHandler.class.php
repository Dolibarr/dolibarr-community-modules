...
class CdarHandler
{
	...
	public function generate($data)
	{
		...
		// Same stamp as the invoice XML (CIIProtocol::buildXML()): a lifecycle answer received by a
		// partner says which Dolibarr and which module build wrote it, otherwise a malformed CDAR
		// can only be traced back by asking the sender.
		$textforcomment = 'CDAR XML generated by';
		...
		$root->appendChild($dom->createComment($textforcomment));
